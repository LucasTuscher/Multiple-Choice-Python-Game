    ...
    return [
        ...
        Question(
            ...
            options={
                ...
                "B": "Eine gerichtete Größe mit Betrag und Richtung",
                "C": "Eine Matrix mit einer Zeile",
                "D": "Ein Farbwert"
            },
            correct={"B"},
            explain_correct="Ein Vektor ist eine gerichtete Größe, die durch Betrag (Laenge) und "
                          "Richtung definiert ist. In der Computergrafik werden Vektoren für Positionen, "
                          "Richtungen (z.B. Normalen, Blickrichtung), Geschwindigkeiten und Kräfte verwendet. "
            ...
            explain_wrong={
                ...
                "D": "Farbwerte können als Vektoren dargestellt werden, sind aber nicht die Definition."
            },
        ...
        Question(
            ...
            explain_correct="Das Skalarprodukt (Dot Product) zweier Vektoren ergibt eine einzelne Zahl (Skalar). "
                          ...
                          "Es wird häufig verwendet um: Winkel zu berechnen, zu prüfen ob Vektoren senkrecht stehen "
                          "(dot=0), oder für Beleuchtungsberechnungen (Lambertsches Gesetz).",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "C": "Wird für Normalenberechnung verwendet",
            ...
            explain_correct="Das Kreuzprodukt zweier Vektoren a und b ergibt einen neuen Vektor, "
                          ...
                          "Es wird häufig verwendet um: Flächennormalen zu berechnen, "
        ...
        Question(
            ...
            explain_correct="Eine Matrix ist ein rechteckiges Schema von Zahlen. In der Computergrafik werden "
                          ...
                          "darzustellen. Durch Matrixmultiplikation können mehrere Transformationen kombiniert werden. "
        ...
        Question(
            ...
            options={
                "A": "Weil 4D-Grafiken schöner aussehen",
                "B": "Um Translation als Matrixmultiplikation darstellen zu können",
                "C": "Weil die GPU nur 4D kann",
                "D": "Für bessere Farbdarstellung"
            },
            correct={"B"},
            explain_correct="Mit homogenen Koordinaten (x, y, z, w) kann man Translation als 4x4-Matrix ausdruecken. "
                          ...
                          "Mit der vierten Koordinate w können alle affinen Transformationen (Translation, Rotation, "
            ...
            explain_wrong={
                ...
                "C": "GPUs können auch mit 3D arbeiten.",
        ...
        Question(
            ...
            explain_wrong={
                ...
                "C": "w=0 ist gültig für Richtungsvektoren.",
        ...
        Question(
            ...
            correct={"B"},
            explain_correct="Der Vertex Shader ist ein Programm, das für jeden Vertex ausgeführt wird. "
                          ...
                          "Normalen, Texturkoordinaten, oder Beleuchtungswerte für Gouraud-Shading.",
            explain_wrong={
        ...
        Question(
            ...
            correct={"B"},
            explain_correct="Der Fragment Shader wird für jedes Fragment (potenzielles Pixel) ausgeführt "
                          "und berechnet dessen finale Farbe. Er verwendet dafür interpolierte Werte vom "
                          "Vertex Shader, Texturen, Beleuchtungsberechnungen (Phong-Modell), und andere Effekte. "
                          "Pro Fragment können komplexe Berechnungen wie Normal Mapping oder PBR stattfinden.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="Rasterization (Rasterisierung) wandelt geometrische Primitive (Dreiecke) in diskrete "
                          "Fragmente um. Für jedes Pixel, das von einem Dreieck überdeckt wird, wird ein Fragment "
                          "erzeugt. Dabei werden die Vertex-Attribute (Position, Farbe, Texturkoordinaten, Normalen) "
                          "per baryzentrischer Interpolation über das Dreieck verteilt.",
            explain_wrong={
                "B": "Texturen werden separat geladen.",
                "C": "Kompression ist ein separater Prozess.",
                "D": "Schatten werden in Shadern oder extra Pässen berechnet."
            },
            topic="Computergrafik - Pipeline"
        ),
        ...
        Question(
            ...
            options={
                ...
                "B": "Speichert die Tiefe jedes Pixels für verdeckte Flächen",
                "C": "Speichert die Texturkoordinaten",
                "D": "Speichert die Vertex-Positionen"
            },
            correct={"B"},
            explain_correct="Der Z-Buffer (Depth Buffer) speichert für jedes Pixel die Tiefe (Z-Koordinate, "
                          "Entfernung zur Kamera) des nächsten sichtbaren Fragments. Beim Rendern wird geprüft, "
                          "ob ein neues Fragment näher ist als der gespeicherte Wert. Nur wenn ja, wird das Pixel "
                          "aktualisiert. So werden verdeckte Flächen korrekt behandelt ohne Sortierung.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "C": "Speichert ganzzahlige Werte für Masken und Spezialeffekte",
                "D": "Speichert Texturkoordinaten"
            },
            correct={"C"},
            explain_correct="Der Stencil Buffer speichert einen ganzzahligen Wert (meist 8 Bit) pro Pixel. "
                          "Er wird verwendet für: Schattenvolumen (Shadow Volumes), Spiegeleffekte, "
        ...
        Question(
            ...
            explain_correct="Die programmierbaren Shader-Stufen sind: Vertex Shader (pro Vertex), "
                          "Geometry Shader (kann Geometrie erzeugen/ändern, optional), "
                          "Tessellation Shaders (für Unterteilung, optional), und Fragment Shader (pro Fragment). "
        ...
        Question(
            ...
            explain_correct="Ein Vertex ist ein Eckpunkt im 3D-Raum. Er hat mindestens eine Position (x,y,z), "
                          "kann aber viele weitere Attribute haben: Normale (für Beleuchtung), Texturkoordinaten (UV), "
                          "Vertex-Farbe, Tangente (für Normal Mapping), Bone-Gewichte (für Skelett-Animation), etc. "
        ...
        Question(
            ...
            options={
                "A": "Standardwerte für Variablen",
                "B": "Vektoren die senkrecht zur Oberfläche stehen",
                "C": "Durchschnittliche Farbwerte",
                "D": "Komprimierte Texturen"
            },
            correct={"B"},
            explain_correct="Normalen sind Einheitsvektoren (Laenge 1) die senkrecht zur Oberfläche stehen. "
                          "Sie sind essentiell für Beleuchtungsberechnungen: Das Skalarprodukt zwischen Normale "
                          "und Lichtrichtung bestimmt die Helligkeit (Lambertsches Gesetz). "
                          "Face-Normalen gelten pro Dreieck, Vertex-Normalen pro Vertex (für glatte Schattierung).",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "C": "Ultraviolett-Werte für Beleuchtung",
                "D": "Kameraposition"
            },
            correct={"B"},
            explain_correct="UV-Koordinaten (U=horizontal, V=vertikal) geben an, welcher Punkt einer 2D-Textur "
                          "auf welchen Punkt der 3D-Oberfläche gemappt wird. Der Wertebereich ist meist 0-1, "
            ...
            explain_wrong={
                ...
                "C": "UV steht nicht für Ultraviolett.",
        ...
        Question(
            ...
            explain_correct="Ein Mesh (Polygonnetz) ist eine Sammlung von Vertices, Edges und Faces, "
                          "die zusammen die Oberfläche eines 3D-Objekts beschreiben. Die Faces sind "
                          "meist Dreiecke (triangle mesh) oder Vierecke (quad mesh). Ein Mesh enthält "
        ...
        Question(
            ...
            options={
                ...
                "D": "Aus historischen Gründen"
            },
            correct={"B"},
            explain_correct="Dreiecke sind das einfachste Polygon und haben wichtige Eigenschaften: "
                          "Sie sind immer planar (liegen in einer Ebene), konvex, und haben keine Löcher. "
            ...
            explain_wrong={
                ...
                "D": "Es gibt handfeste technische Gründe."
            },
            topic="Computergrafik - Geometrie"
        ),
        ...
        Question(
            ...
            explain_correct="Ein konvexes Polygon hat alle Innenwinkel kleiner als 180 Grad - "
                          "eine Linie zwischen zwei Punkten im Polygon liegt immer vollständig im Polygon. "
            ...
            explain_wrong={
                "B": "Die Anzahl der Ecken ist unabhängig von Konvexität.",
                "C": "Farbe hat nichts mit Konvexität zu tun.",
        ...
        Question(
            ...
            explain_correct="Translation (Verschiebung um einen Vektor), Rotation (Drehung um eine Achse/Winkel), "
                          "und Skalierung (Vergrößerung/Verkleinerung) sind die drei grundlegenden affinen "
                          "Transformationen. Zusätzlich gibt es Scherung (Shearing) und Spiegelung. "
                          "In homogenen Koordinaten können alle als 4x4-Matrizen dargestellt werden.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="Die SRT-Reihenfolge (Scale-Rotate-Translate) ist Standard: "
                          ...
                          "Andere Reihenfolgen führen zu unerwarteten Ergebnissen, da Matrixmultiplikation "
        ...
        Question(
            ...
            options={
                ...
                "D": "Definiert die Bildschirmauflösung"
            },
            correct={"B"},
            explain_correct="Die Model-Matrix (auch World Matrix) transformiert ein Objekt aus seinem lokalen "
                          ...
                          "Weltkoordinatensystem (Position, Rotation, Größe in der Szene). "
                          "Sie enthält die SRT-Transformationen des Objekts.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="Die Projection-Matrix transformiert von Kamerakoordinaten in Clip-Koordinaten "
                          ...
                          "Bei orthografischer Projektion bleibt die Größe konstant.",
            explain_wrong={
                "A": "Das ist die Model-Matrix.",
        ...
        Question(
            ...
            explain_correct="Perspektivische Projektion simuliert das menschliche Sehen: Weiter entfernte Objekte "
                          "erscheinen kleiner (perspektivische Verkürzung). Sie wird definiert durch "
                          "Field of View (Öffnungswinkel), Aspect Ratio, Near Plane und Far Plane. "
                          "Orthografische Projektion erhielt parallele Linien und konstante Größen - "
                          "verwendet für CAD, 2D-Spiele, oder isometrische Ansichten.",
            explain_wrong={
                "A": "Beide sind ähnlich schnell.",
        ...
        Question(
            ...
            options={
                "A": "Ein Würfel",
                "B": "Der pyramidenförmige/quaderförmige Sichtbereich der Kamera",
                "C": "Ein Texturtyp",
                "D": "Ein Shader"
            },
            correct={"B"},
            ...
            explain_wrong={
                "A": "Ein Würfel entsteht nur bei orthografischer Projektion mit gleichem Aspect Ratio.",
        ...
        Question(
            ...
            explain_correct="Die MVP-Matrix ist das Produkt von Model, View und Projection Matrix. "
                          ...
                          "in Clip-Koordinaten (bereit für Rasterisierung). Oft wird sie einmal pro Frame "
                          "berechnet und an den Vertex Shader übergeben, um Rechenaufwand zu sparen.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "B": "Ein additives Farbmodell mit Rot, Grün, Blau",
                "C": "Ein Druckfarbmodell",
                "D": "Ein Modell für Schwarzweiss-Bilder"
            },
            correct={"B"},
            explain_correct="RGB ist ein additives Farbmodell: Rot, Grün und Blau werden gemischt, "
                          "wobei volle Intensität aller drei Weiss ergibt und keine Farbe Schwarz. "
                          "Es wird für selbstleuchtende Displays (Monitore, TVs) verwendet. "
        ...
        Question(
            ...
            options={
                "A": "RGB ohne Rot",
                "B": "RGB plus Alpha-Kanal für Transparenz",
            ...
            explain_correct="RGBA erweitert RGB um einen vierten Kanal: Alpha (A). Der Alpha-Kanal speichert "
                          "die Transparenz/Deckkraft des Pixels. A=1.0 (oder 255) bedeutet völlig undurchsichtig, "
                          "A=0.0 bedeutet völlig durchsichtig. RGBA ist essentiell für Compositing, "
        ...
        Question(
            ...
            options={
                "A": "Additiv: Lichter überlagern sich (RGB). Subtraktiv: Farben absorbieren Licht (CMYK)",
                "B": "Additiv ist für Druck, subtraktiv für Bildschirme",
                "C": "Es gibt keinen Unterschied",
                "D": "Additiv erzeugt dunklere Farben"
            },
            correct={"A"},
            explain_correct="Additives Farbmischen (RGB): Lichtquellen überlagern sich, mehr Farbe = heller, "
        ...
        Question(
            ...
            explain_correct="HSV (Hue, Saturation, Value) bzw. HSB (Hue, Saturation, Brightness) beschreibt Farben "
                          ...
                          "Value/Brightness die Helligkeit (0=schwarz bis 1=hell). Ideal für Farbauswahl-Tools.",
            explain_wrong={},
            topic="Computergrafik - Licht und Farbe"
        ),
        ...
        Question(
            ...
            explain_correct="Gammakorrektur kompensiert die nichtlineare Beziehung zwischen elektrischem Signal "
                          ...
                          "sRGB (Standard für Monitore) hat Gamma ≈ 2.2. Für korrekte Berechnungen muss man "
                          "in linearen Farbraum konvertieren, rechnen, und dann zurück zu Gamma.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="sRGB ist der Standard-Farbraum mit eingebauter Gammakorrektur (~2.2). "
                          "Bilder und Texturen sind meist in sRGB kodiert. Für physikalisch korrekte "
                          "Beleuchtungsberechnungen muss in linearen Farbraum konvertiert werden "
                          "(Entfernung des Gammas), dann gerechnet, und am Ende zurück zu sRGB für die Ausgabe.",
            explain_wrong={
                "B": "Beide können gleich viele Farben darstellen.",
                "C": "sRGB ist der aktuelle Standard.",
                "D": "Der Unterschied ist wichtig für korrekte Berechnungen."
            },
            topic="Computergrafik - Licht und Farbe"
        ),
        ...
        Question(
            ...
            explain_wrong={
                "B": "Die Auflösung ist die Pixelanzahl, nicht die Farbtiefe.",
        ...
        Question(
            ...
            explain_correct="Licht in der Computergrafik wird beschrieben durch: "
                          "Farbe (RGB oder Spektrum), Intensität (wie hell), Richtung (woher es kommt), "
        ...
        Question(
            ...
            explain_correct="Directional Light: Parallele Strahlen aus unendlicher Entfernung (Sonne). "
                          "Point Light: Strahlt in alle Richtungen von einem Punkt (Glühbirne). "
                          "Spot Light: Kegel aus einem Punkt (Taschenlampe). "
                          "Ambient Light: Konstantes Licht überall, simuliert indirektes Licht. "
        ...
        Question(
            ...
            options={
                ...
                "B": "Die Intensitätsabnahme des Lichts mit zunehmender Entfernung",
            ...
            explain_correct="Attenuation beschreibt, wie die Lichtintensitaet mit der Entfernung abnimmt. "
                          "Physikalisch korrekt wäre 1/d² (inverse square law), aber in Spielen werden oft "
            ...
            explain_wrong={
                "A": "Die Farbe bleibt gleich, nur die Intensität nimmt ab.",
                "C": "Die Richtung aendert sich nicht.",
                "D": "Texturen sind unabhängig von Attenuation."
            },
            topic="Computergrafik - Licht und Farbe"
        ),
        ...
        Question(
            ...
            explain_correct="Das Phong-Beleuchtungsmodell besteht aus drei Komponenten: "
                          ...
                          "Diffuse = gestreutes Licht abhängig vom Winkel Licht-Normale (Lambert). "
                          "Specular = Glanzpunkte abhängig vom Winkel Reflexion-Betrachter. "
        ...
        Question(
            ...
            options={
                "A": "Die Reflexion an glatten Oberflächen",
                "B": "Die diffuse Reflexion: Intensität ~ cos(Winkel zwischen Normale und Licht)",
                "C": "Die Lichtbrechung",
                "D": "Die Farbmischung"
            },
            correct={"B"},
            explain_correct="Das Lambertsche Kosinusgesetz beschreibt ideale diffuse Reflexion: "
                          "Die reflektierte Intensität ist proportional zum Kosinus des Winkels zwischen "
                          "Oberflächennormale und Lichtrichtung. Mathematisch: I_diffuse = k_d * I_light * max(0, N·L). "
                          "Dadurch werden Flächen, die dem Licht zugewandt sind, heller.",
            explain_wrong={
                "A": "Glatte Reflexion wird durch Specular beschrieben.",
                "C": "Lichtbrechung ist ein anderes Phänomen.",
        ...
        Question(
            ...
            options={
                ...
                "B": "Steuert die Größe/Schärfe des Glanzpunkts",
                "C": "Die Position der Lichtquelle",
                "D": "Die Texturaufloesung"
            },
            correct={"B"},
            explain_correct="Der Specular-Exponent (n oder shininess) steuert die Größe des Glanzpunkts: "
                          "Ein niedriger Wert (z.B. 2) ergibt einen großen, weichen Glanz (matte Oberfläche). "
                          "Ein hoher Wert (z.B. 256) ergibt einen kleinen, scharfen Glanzpunkt (polierte Oberfläche). "
        ...
        Question(
            ...
            explain_correct="Gouraud-Shading (1971): Beleuchtung wird pro Vertex berechnet, "
                          "die resultierenden Farben werden über das Dreieck interpoliert. Schnell, aber "
                          ...
                          "Bessere Qualität (scharfe Glanzpunkte), aber aufwendiger.",
            explain_wrong={
                "B": "Gouraud kam vor Phong (1971 vs 1975).",
                "C": "Phong ist genauer als Gouraud.",
                "D": "Der Qualitätsunterschied ist sichtbar."
            },
            topic="Computergrafik - Beleuchtung"
        ),
        ...
        Question(
            ...
            options={
                ...
                "B": "Farben werden über das Dreieck interpoliert",
            ...
            explain_correct="Flat Shading ist die einfachste Schattierungsmethode: Jedes Dreieck wird "
                          "mit einer einzigen Farbe gefüllt, berechnet aus der Face-Normale. "
                          "Das Ergebnis sieht facettiert aus (man sieht die einzelnen Dreiecke). "
                          "Schnell, aber für organische Formen ungeeignet.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="PBR ist ein modernes Beleuchtungsmodell, das physikalische Gesetze beachtet: "
                          ...
                          "Mikrofacetten-Theorie (rauhe Oberflächen). Parameter sind meist: "
        ...
        Question(
            ...
            options={
                "A": "Ein Farbfilter",
                "B": "Stärkere Reflexion bei flachen Betrachtungswinkeln",
                "C": "Ein Texturtyp",
                "D": "Eine Schattenart"
            },
            correct={"B"},
            explain_correct="Der Fresnel-Effekt beschreibt, dass Oberflächen bei flachen Betrachtungswinkeln "
                          "(Blickrichtung fast parallel zur Oberfläche) mehr reflektieren als bei steilen Winkeln. "
                          "Ein See erscheint bei flachem Blick spiegelnd, bei steilem Blick durchsichtig. "
                          "PBR-Shader nutzen die Fresnel-Gleichungen für realistische Reflexionen.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                "A": "Lokal berücksichtigt nur direkte Beleuchtung, global auch indirekte (Reflexionen, Lichtbounces)",
            ...
            explain_correct="Lokale Beleuchtung (z.B. Phong) berechnet nur direkte Beleuchtung - Licht von "
                          "der Quelle direkt zur Oberfläche. Globale Beleuchtung berücksichtigt auch "
        ...
        Question(
            ...
            options={
                "A": "Ein Texturfilter",
                "B": "Simulation von Lichtstrahlen durch die Szene für realistische Beleuchtung",
            ...
            explain_correct="Ray Tracing verfolgt Lichtstrahlen (meist von der Kamera in die Szene - Backwards Ray Tracing). "
                          "Für jeden Pixel wird ein Strahl geschickt, Schnittpunkte mit Geometrie berechnet, "
        ...
        Question(
            ...
            options={
                ...
                "B": "Monte-Carlo-Methode zur Berechnung globaler Beleuchtung durch zufällige Strahlenverfolgung",
                "C": "Ein Texturtyp",
            ...
            explain_correct="Path Tracing ist eine fortgeschrittene Ray Tracing Variante, die Monte-Carlo-Integration "
                          "verwendet. Für jeden Pixel werden viele zufällige Pfade durch die Szene verfolgt, "
                          "die an Oberflächen abprallen. Durch Mittelung über viele Samples konvergiert das "
        ...
        Question(
            ...
            explain_correct="Ambient Occlusion (AO) simuliert, wie viel Umgebungslicht an jeden Punkt gelangt. "
                          ...
                          "berechnet. Es fügt Tiefe und Realismus hinzu, ist aber eine Approximation.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "B": "Berechnung diffuser Interreflexionen zwischen Flächen",
                "C": "Ein Kompressionsverfahren",
                "D": "Eine Animationstechnik"
            },
            correct={"B"},
            explain_correct="Radiosity berechnet den Lichtaustausch zwischen diffusen Oberflächen. "
                          "Anders als Ray Tracing ist es ansichtsunabhängig - die Lösung kann einmal berechnet "
                          "und dann aus beliebigen Blickwinkeln betrachtet werden (gut für statische Szenen). "
                          "Es erzeugt weiche Schatten und Color Bleeding (Farbübertraege zwischen Oberflächen).",
            explain_wrong={
        ...
        Question(
            ...
            options={
                "A": "Das Auftragen von 2D-Bildern auf 3D-Oberflächen",
                "B": "Das Erstellen von 3D-Modellen",
                "C": "Die Animation von Objekten",
                "D": "Die Beleuchtungsberechnung"
            },
            correct={"A"},
            explain_correct="Texture Mapping ist die Technik, 2D-Bilder (Texturen) auf 3D-Oberflächen zu projizieren. "
                          "UV-Koordinaten an jedem Vertex geben an, welcher Teil der Textur dort angezeigt wird. "
                          "Zwischen Vertices werden die UVs interpoliert. So können komplexe Details "
                          "(Holzmaserung, Ziegelmauer) ohne zusätzliche Geometrie dargestellt werden.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="Texture Filtering bestimmt, wie Texelwerte ermittelt werden, wenn die Texturkoordinaten "
                          "nicht exakt auf Texel-Zentren fallen. Nearest-Neighbor: nächster Texel (pixelig). "
                          "Bilinear: gewichteter Durchschnitt der 4 nächsten Texel. "
                          "Trilinear: Bilinear + Interpolation zwischen Mipmap-Stufen. "
                          "Anisotropic: berücksichtigt Blickwinkel auf die Textur.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                ...
                "B": "Vorberechnete verkleinerte Versionen einer Textur für verschiedene Distanzen",
            ...
            explain_correct="Mipmaps sind vorberechnete verkleinerte Versionen einer Textur (je halb so gross: "
                          "Original, 1/2, 1/4, 1/8... bis 1x1). Je nach Entfernung/Größe auf dem Bildschirm "
            ...
            explain_wrong={
                ...
                "C": "Kompression ist unabhängig von Mipmaps.",
        ...
        Question(
            ...
            options={
                ...
                "B": "Simulation von Oberflächendetails durch Normalen-Texturen",
                "C": "Ein Kompressionsverfahren",
                "D": "Eine Animationstechnik"
            },
            correct={"B"},
            explain_correct="Normal Mapping verwendet eine spezielle Textur (Normal Map), die pro Texel eine "
                          ...
                          "bei der Beleuchtungsberechnung. So können feine Oberflächendetails (Rillen, Poren, Nieten) "
                          "ohne zusätzliche Geometrie dargestellt werden. Die Silhouette bleibt aber glatt.",
            explain_wrong={
        ...
        Question(
            ...
            explain_correct="Parallax Mapping verschiebt Texturkoordinaten basierend auf einer Height Map "
                          ...
                          "Displacement Mapping geht weiter und verschiebt tatsächlich die Geometrie "
                          "(meist im Tessellation Shader). Ergebnis: Realistische 3D-Oberflächen "
        ...
        Question(
            ...
            options={
                ...
                "B": "Texturfilterung die den Blickwinkel berücksichtigt",
            ...
            explain_correct="Anisotropic Filtering (AF) ist eine verbesserte Texturfilterung, die den Blickwinkel "
                          "auf die texturierte Oberfläche berücksichtigt. Bei flachen Winkeln (z.B. Strasse in die Ferne) "
                          "sampelt es mehr Texel in Richtung der Verzerrung. Ergebnis: Scharfe Texturen auch bei "
                          "schrägen Winkeln, ohne übertriebene Unschaerfe. Einstellbar: 2x, 4x, 8x, 16x AF.",
            explain_wrong={
        ...
        Question(
            ...
            options={
                "A": "Ein Programm das auf der GPU läuft",
                "B": "Berechnet visuelle Eigenschaften wie Farbe, Position, Beleuchtung",
                "C": "Wird für jeden Vertex oder jedes Fragment ausgeführt",
            },
            correct={"A", "B", "C"},
            explain_correct="Ein Shader ist ein Programm, das auf der GPU läuft und einen Teil der Rendering-Pipeline "
                          "steuert. Vertex Shader transformieren Vertices, Fragment Shader berechnen Pixelfarben. "
                          "Shader werden massiv parallel ausgeführt - die gleiche Anweisung für viele Vertices/Fragmente "
        ...
        Question(
            ...
            explain_correct="Moderne GPUs unterstuetzen verschiedene Shader-Stufen: "
                          ...
                          "Tessellation Shaders (Hull + Domain, für Unterteilung, optional), "
        ...
        Question(
            prompt="Was ist GLSL?",
            options={
                "A": "Eine Programmiersprache für OpenGL-Shader",
                "B": "Ein Bildformat",
                "C": "Ein 3D-Modell-Format",
                "D": "Eine Texturkompression"
            },
            correct={"A"},
            explain_correct="GLSL (OpenGL Shading Language) ist die Shader-Programmiersprache für OpenGL/OpenGL ES. "
                          "Sie hat eine C-ähnliche Syntax mit speziellen Typen für Vektoren (vec2, vec3, vec4), "
        ...
        Question(
            ...
            options={
                "A": "Ein Shader für Vertex-Transformation",
                "B": "Ein Shader für allgemeine Berechnungen (GPGPU), nicht Teil der Rendering-Pipeline",
                "C": "Ein Shader für Pixelfarben",
                "D": "Ein Shader für Audio"
            },
            correct={"B"},
            explain_correct="Compute Shader sind für allgemeine Berechnungen auf der GPU (GPGPU - General Purpose GPU). "
                          "Sie sind nicht Teil der Rendering-Pipeline und haben keine festen Ein-/Ausgaben. "
                          "Verwendet für: Partikel-Physik, Post-Processing, Simulation, Machine Learning, etc. "
                          "Sie arbeiten in Arbeitsgruppen (Work Groups) und können auf Texturen und Buffer zugreifen.",
            explain_wrong={
                "A": "Vertex-Transformation macht der Vertex Shader.",
                "C": "Pixelfarben berechnet der Fragment Shader.",
                "D": "Audio-Verarbeitung läuft meist auf der CPU."
            },
            topic="Computergrafik - Shader"
        ),
        ...
        Question(
            ...
            options={
                "A": "Variablen die für alle Vertices/Fragmente gleich sind (von CPU gesetzt)",
                "B": "Variablen die pro Vertex unterschiedlich sind",
                "C": "Ausgabewerte des Shaders",
                "D": "Texturkoordinaten"
            },
            correct={"A"},
            explain_correct="Uniforms sind Shader-Variablen, die von der CPU gesetzt werden und für alle "
        ...
        Question(
            ...
            explain_correct="Varying (in GLSL 'out' vom Vertex Shader, 'in' im Fragment Shader) sind Werte, "
                          "die vom Vertex Shader berechnet und per Rasterisierung über das Dreieck "
                          "zum Fragment Shader interpoliert werden. Typische Varyings: Texturkoordinaten, "
                          "Normalen, Positionen, Farben. Die Interpolation ist standardmäßig perspektivisch korrekt.",
            explain_wrong={
                "A": "Varyings ändern sich pro Fragment.",
                "C": "Texturen werden über Sampler zugegriffen.",
        ...
        Question(
            ...
            options={
                ...
                "D": "Das Faerben der Rückseite"
            },
            correct={"A"},
            explain_correct="Backface Culling entfernt Dreiecke, deren Normale von der Kamera weg zeigt "
                          "(Rückseite). Bei geschlossenen Objekten ist die Rückseite nie sichtbar. "
                          "Die Vorderseite wird durch die Vertex-Reihenfolge bestimmt (Counter-Clockwise = Front). "
                          "Spart ca. 50% Rendering-Arbeit. Kann deaktiviert werden für transparente oder "
                          "doppelseitige Objekte.",
            explain_wrong={
                "B": "Nur Rückseiten werden entfernt.",
                "C": "Sortieren ist ein anderer Prozess.",
                "D": "Die Rückseite wird verworfen, nicht gefaerbt."
            },
        ...
        Question(
            ...
            correct={"A"},
            explain_correct="Frustum Culling entfernt ganze Objekte, die vollständig ausserhalb des "
                          "View Frustums (Sichtpyramide der Kamera) liegen, bevor sie an die GPU gesendet werden. "
                          "Prüfung erfolgt mit Bounding Volumes (Bounding Box, Bounding Sphere). "
                          "Wichtige CPU-seitige Optimierung, besonders bei großen Szenen.",
            explain_wrong={
        ...
        Question(
            ...
            explain_wrong={
                ...
                "C": "Pixelfärben macht der Fragment Shader.",
        ...
        Question(
            ...
            options={
                "A": "Entfernen von Objekten die von anderen Objekten vollständig verdeckt werden",
                "B": "Entfernen der Rückseiten",
            ...
            explain_correct="Occlusion Culling identifiziert und entfernt Objekte, die zwar im Frustum liegen, "
                          "aber vollständig von anderen Objekten verdeckt werden (occluded). "
                          "Techniken: Hardware Occlusion Queries, Software Rasterization, Hierarchische Z-Buffer. "
                          "Wichtig für Innenräume und dichte Szenen. Komplexer als Frustum Culling.",
            explain_wrong={
                "B": "Das ist Backface Culling.",
                "C": "Kleine Objekte zu entfernen wäre LOD.",
        ...
        Question(
            ...
            options={
                ...
                "B": "Verwendung vereinfachter Modelle für entfernte Objekte",
                "C": "Eine Texturkompression",
                "D": "Ein Soundeffekt"
            },
            correct={"B"},
            explain_correct="Level of Detail (LOD) ist eine Optimierungstechnik, bei der für entfernte Objekte "
                          "vereinfachte Versionen (weniger Polygone) verwendet werden. Je näher das Objekt, "
                          "desto detaillierter das Modell. Das spart Rendering-Zeit ohne sichtbare Qualitätseinbussen, "
                          "da kleine Objekte ohnehin wenige Pixel bedecken. Ähnliches Konzept wie Mipmaps für Texturen.",
            explain_wrong={
                "A": "LOD ist eine Geometrie-Optimierung.",
                "C": "Mipmaps sind LOD für Texturen, aber LOD allgemein bezieht sich auf Geometrie.",
        ...
        Question(
            ...
            options={
                "A": "Rendern mit höherer Auflösung",
                "B": "Rendern mit erweitertem Helligkeitsbereich (über 0-1)",
                "C": "Rendern mit mehr Polygonen",
                "D": "Rendern ohne Farben"
            },
            correct={"B"},
            explain_correct="HDR Rendering arbeitet mit einem erweiterten Helligkeitsbereich - Werte können "
                          "größer als 1.0 sein (z.B. eine Sonne mit Intensität 10.0). Das Rendering erfolgt "
            ...
            explain_wrong={
                "A": "Auflösung ist unabhängig von HDR.",
                "C": "Polygonzahl ist unabhängig von HDR.",
        ...
        Question(
            ...
            explain_correct="Tone Mapping ist der Prozess, HDR-Bilder (hoher Dynamikumfang) auf "
                          ...
                          "den Helligkeitsbereich auf eine künstlerisch ansprechende Weise, "
                          "erhält Details in hellen und dunklen Bereichen. Bekannte Operatoren: "
                          "Reinhard, ACES, Filmic. Oft kombiniert mit Exposure-Kontrolle.",
            explain_wrong={
                "A": "Tone Mapping ist für Bilder, nicht Audio.",
                "C": "Kompression ist ein anderes Thema.",
                "D": "Animation ist ein anderes Thema."
            },
            topic="Computergrafik - Moderne Techniken"
        ...
        Question(
            ...
            explain_correct="Post-Processing sind Bildeffekte, die auf das fertig gerenderte Bild "
                          ...
                          "Motion Blur, Depth of Field (Tiefenunschärfe), Color Grading, SSAO, FXAA/TAA, "
        ...
        Question(
            ...
            explain_correct="SSAO ist eine Echtzeit-Approximation von Ambient Occlusion im Screen Space. "
                          "Es verwendet den Depth-Buffer um abzuschätzen, wie viel Umgebungslicht "
                          "jeden Pixel erreicht. Samples werden in einer Halbkugel um jeden Pixel genommen "
                          "und gegen den Depth-Buffer geprüft. Schnell, aber nur Screen Space (keine verdeckten Bereiche).",
            explain_wrong={
        ...
        Question(
            ...
            options={
                "A": "Glättung von Treppeneffekten an Kanten",
            ...
            explain_correct="Anti-Aliasing reduziert 'Treppchen' (Jaggies) an Kanten. "
                          ...
                          "SSAA: Rendering in höherer Auflösung, dann Downscaling (sehr aufwendig). "
                          "FXAA/SMAA: Post-Processing basiert, schnell aber kann Details weichzeichnen. "
                          "TAA: Temporal, nutzt Daten aus vorherigen Frames, gute Qualität bei Bewegung.",
            explain_wrong={},
            topic="Computergrafik - Moderne Techniken"
        ),
    ]
